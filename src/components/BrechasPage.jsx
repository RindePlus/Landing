...
const ShareIosIcon = () => (
  <span className="rp-brechas__pwa-inline-icon" aria-label="Ícono compartir iOS">
...
const ANDROID_STEPS = [
  ...
  <>
    Tocá el menú <span className="rp-brechas__pwa-dots">⋮</span> (los tres puntos, arriba a la derecha).
  </>,
...
const HeroSection = ({ onGoToPricing }) => (
  <section className="rp-brechas__hero" id="top">
    <div className="rp-brechas__hero-grid" />
    <div className="rp-brechas__hero-inner">
      <div className="rp-brechas__hero-copy">
        <span className="rp-brechas__hero-eyebrow rp-fade-in rp-d-0">
          <span className="rp-brechas__hero-eyebrow-dot" />
          Análisis agronómico
        </span>

        <h1 className="rp-brechas__hero-title rp-fade-in rp-d-1">
          Análisis y <em>brechas</em>
        </h1>

        <p className="rp-brechas__hero-subtitle rp-fade-in rp-d-3">
          Toda tu información en un solo lugar.
        </p>

        <div className="rp-brechas__hero-ctas rp-fade-in rp-d-4">
          <a
            className="rp-brechas__hero-btn rp-brechas__hero-btn--primary"
            href={PRONOSTICOS_LOGIN_URL}
            target="_blank"
          ...
          <button
            type="button"
            className="rp-brechas__hero-btn rp-brechas__hero-btn--ghost"
      ...
      <div className="rp-brechas__hero-visual rp-fade-in rp-d-2">
        <div className="rp-brechas__hero-visual-glow" />
        <div className="rp-brechas__hero-card">
          <div className="rp-brechas__hero-card-bar" />
          <img src={cosechadoraBg} alt="Análisis y brechas de rendimiento" loading="eager" />
        </div>
      </div>
    </div>
  </section>
...
const LaPlataformaSection = () => (
  <section className="rp-brechas__section" id="que-es">
    ...
    <Reveal>
      <div className="rp-brechas__que-grid rp-brechas__que-grid--single">
        <article className="rp-brechas__que-card rp-brechas__que-card--a">
          <ul className="rp-brechas__que-list">
            <li>
              <span className="rp-brechas__que-check"><FaCheck /></span>
              <span className="rp-brechas__que-text">
...
const ComoFunciona = () => (
  <section className="rp-brechas__section" id="como-funciona">
    <Reveal className="rp-brechas__section-header">
      <div className="rp-brechas__eyebrow">Tres pasos</div>
      <h2 className="rp-brechas__section-title">
        Cómo{' '}
        <span className="rp-brechas__section-title-accent">funciona</span>
      </h2>
      <p className="rp-brechas__section-subtitle">
    ...
    <Reveal>
      <div className="rp-brechas__steps-grid">
        {STEPS.map((step) => (
          <article
            key={step.num}
            className={`rp-brechas__step rp-brechas__step--${step.accent}`}
          >
            <div className="rp-brechas__step-bar" />
            <div className="rp-brechas__step-body">
              <div className="rp-brechas__step-num">{step.num}</div>
              <h3 className="rp-brechas__step-title">{step.title}</h3>
              <p className="rp-brechas__step-copy">{step.copy}</p>
            </div>
          </article>
        ))}
      </div>
...
const ReporteSection = () => (
  <section className="rp-brechas__section" id="reporte">
    <Reveal className="rp-brechas__section-header">
      <div className="rp-brechas__eyebrow">El reporte</div>
      <h2 className="rp-brechas__section-title">
        Lo que te muestra{' '}
        <span className="rp-brechas__section-title-accent">tu reporte</span>
      </h2>
      <p className="rp-brechas__section-subtitle">
...
const ComoEmpezar = () => (
  <section className="rp-brechas__section" id="como-empezar">
    <Reveal className="rp-brechas__section-header">
      <div className="rp-brechas__eyebrow">Onboarding</div>
      <h2 className="rp-brechas__section-title">
        Cómo{' '}
        <span className="rp-brechas__section-title-accent">empezás a usarla</span>
      </h2>
      <p className="rp-brechas__section-subtitle">
    ...
    <Reveal>
      <ol className="rp-brechas__reasons">
        {ONBOARDING_STEPS.map((step, i) => (
          <li key={step.title} className="rp-brechas__reason">
            <span className="rp-brechas__reason-num">
              {String(i + 1).padStart(2, '0')}
            </span>
            <span className="rp-brechas__reason-bar" />
            <div className="rp-brechas__reason-content">
              <h4>{step.title}</h4>
              <p>{step.copy}</p>
            </div>
          </li>
    ...
    <Reveal>
      <div className="rp-brechas__support">
...
const InstalarApp = () => (
  <section className="rp-brechas__section" id="instalar-app">
    <Reveal className="rp-brechas__section-header">
      <div className="rp-brechas__eyebrow">PWA</div>
      <h2 className="rp-brechas__section-title">
        Instalá la plataforma{' '}
        <span className="rp-brechas__section-title-accent">en tu celular</span>
      </h2>
      <p className="rp-brechas__section-subtitle">
    ...
    <Reveal>
      <div className="rp-brechas__pwa-grid">
        <article className="rp-brechas__pwa-card rp-brechas__pwa-card--ios">
          <div className="rp-brechas__pwa-bar" />
          <div className="rp-brechas__pwa-body">
            <div className="rp-brechas__pwa-header">
              <div className="rp-brechas__pwa-badge" aria-hidden="true">
                <FaApple />
              </div>
              <h3 className="rp-brechas__pwa-platform">iOS (iPhone)</h3>
            </div>
            <ol className="rp-brechas__pwa-steps">
              {IOS_STEPS.map((stepText, i) => (
                <li key={i} className="rp-brechas__pwa-step">
                  <span className="rp-brechas__pwa-step-num">{i + 1}</span>
                  <span className="rp-brechas__pwa-step-text">{stepText}</span>
                </li>
              ))}
            </ol>
          </div>
        ...
        <article className="rp-brechas__pwa-card rp-brechas__pwa-card--android">
          <div className="rp-brechas__pwa-bar" />
          <div className="rp-brechas__pwa-body">
            <div className="rp-brechas__pwa-header">
              <div className="rp-brechas__pwa-badge" aria-hidden="true">
              ...
              <h3 className="rp-brechas__pwa-platform">Android</h3>
            </div>
            <ol className="rp-brechas__pwa-steps">
...
const ElProblemaSection = ({ onOpenSources }) => (
  <section className="rp-brechas__section" id="el-problema">
    <Reveal className="rp-brechas__section-header">
      <div className="rp-brechas__eyebrow">El contexto</div>
      <h2 className="rp-brechas__section-title">
        El{' '}
        <span className="rp-brechas__section-title-accent">problema</span>
      </h2>
      <p className="rp-brechas__section-subtitle">
    ...
    <Reveal>
      <div className="rp-brechas__problema-grid">
        {PROBLEMA_CARDS.map((card) => (
          <article
            key={card.id}
            className={`rp-brechas__problema rp-brechas__problema--${card.accent}`}
          >
            <div className="rp-brechas__problema-bar" />
            <div className="rp-brechas__problema-body">
              <div className="rp-brechas__problema-num">{card.num}</div>
              <h3 className="rp-brechas__problema-title">{card.title}</h3>
              <p className="rp-brechas__problema-copy">{card.copy}</p>
              {card.hasSources && (
                <button
                  type="button"
                  className="rp-brechas__sources-btn"
...
const SourcesModal = ({ onClose }) => (
  <div
    className="rp-brechas__modal-overlay"
    onClick={onClose}
    role="dialog"
    aria-modal="true"
    aria-labelledby="rp-brechas-sources-title"
  >
    <div
      className="rp-brechas__modal"
      onClick={(e) => e.stopPropagation()}
    >
      <div className="rp-brechas__modal-header">
        <h3 id="rp-brechas-sources-title">Fuentes bibliográficas</h3>
        <button
          type="button"
          className="rp-brechas__modal-close"
          onClick={onClose}
      ...
      <div className="rp-brechas__modal-body">
        {SOURCES.map((source) => (
          <div key={source.id} className="rp-brechas__source">
            {source.tag && (
              <span className="rp-brechas__source-tag">{source.tag}</span>
            )}
            <h4>{source.title}</h4>
            {source.citation && (
              <p>
            ...
            {source.detail && (
              <p className="rp-brechas__source-detail">{source.detail}</p>
            )}
            <a
              href={source.href}
              target="_blank"
              rel="noopener noreferrer"
              className="rp-brechas__source-link"
            >
              <FaExternalLinkAlt />
              {source.linkLabel}
            </a>
...
const AhorroTiempoSection = () => (
  <section className="rp-brechas__section" id="ahorro">
    <Reveal className="rp-brechas__section-header">
      <div className="rp-brechas__eyebrow">El valor</div>
      <h2 className="rp-brechas__section-title">
        Tu tiempo vale más que{' '}
        <span className="rp-brechas__section-title-accent">un reporte</span>
      </h2>
      <p className="rp-brechas__section-subtitle">
    ...
    <Reveal>
      <div className="rp-brechas__ahorro-grid">
        {AHORRO_CARDS.map((card) => {
          const IconComp = card.Icon;
          return (
            <article
              key={card.id}
              className={`rp-brechas__ahorro rp-brechas__ahorro--${card.accent}`}
            >
              <div className="rp-brechas__ahorro-bar" />
              <div className="rp-brechas__ahorro-body">
                <div className="rp-brechas__ahorro-icon">
                  <IconComp />
                </div>
                <h3>{card.title}</h3>
                <p>{card.copy}</p>
...
const FinalCta = ({ onGoToPricing }) => (
  <section className="rp-brechas__final">
    <Reveal>
      <div className="rp-brechas__final-card">
        <div className="rp-brechas__final-inner">
          <span className="rp-brechas__final-eyebrow">Comenzá ahora</span>
          <h2 className="rp-brechas__final-title">Comenzá a usarlo</h2>
          <p className="rp-brechas__final-copy">
            Probalo ahora — ingresá directo a la plataforma o conocé nuestros
            planes.
          </p>
          <div className="rp-brechas__final-ctas">
            <a
              className="rp-brechas__final-btn rp-brechas__final-btn--primary"
              href={PRONOSTICOS_LOGIN_URL}
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <button
              type="button"
              className="rp-brechas__final-btn rp-brechas__final-btn--ghost"
              onClick={onGoToPricing}
            >
              Ver Planes y Precios
            </button>
...
const BrechasPage = ({ onOpenWhatsApp, onGoToHome, onGoToPricing }) => {
