...
const VigIAPage = ({ onOpenWhatsApp }) => {
  ...
  return (
    <div className="vigia-page">
      ...
      <section className="vigia-commercial">
        <div className="vigia-commercial-wrapper">
          <h2 className="vigia-commercial-title">Propuesta comercial</h2>
          <h3 className="vigia-commercial-subtitle">Estamos para acompañarte</h3>
          <div className="vigia-commercial-table">
            <table>
              <thead>
                <tr>
                  <th>Productores</th>
              ...
              <tbody>
                <tr>
                  <td rowSpan="10">Campos + lotes</td>
                  <td>Pack lotes I</td>
                  <td>1 Campo - 5 lotes</td>
                  <td>USD 750</td>
                </tr>
                <tr>
                  <td>Pack lotes II</td>
                  <td>2 Campos - 10 lotes</td>
                  <td>USD 740</td>
                </tr>
                <tr>
                  <td>Pack lotes III</td>
                  <td>3 Campos - 15 lotes</td>
                  <td>USD 728</td>
                </tr>
                <tr>
                  <td>Pack lotes IV</td>
                  <td>4 Campos - 20 lotes</td>
                  <td>USD 716</td>
                </tr>
                <tr>
                  <td>Pack lotes V</td>
                  <td>5 Campos - 25 lotes</td>
                  <td>USD 705</td>
                </tr>
                <tr>
                  <td>Pack lotes VI</td>
                  <td>6 Campos - 30 lotes</td>
                  <td>USD 694</td>
                </tr>
                <tr>
                  <td>Pack lotes VII</td>
                  <td>7 Campos - 35 lotes</td>
                  <td>USD 683</td>
                </tr>
                <tr>
                  <td>Pack lotes VIII</td>
                  <td>8 Campos - 40 lotes</td>
                  <td>USD 671</td>
                </tr>
                <tr>
                  <td>Pack lotes IX</td>
                  <td>9 Campos - 45 lotes</td>
                  <td>USD 660</td>
                </tr>
                <tr>
                  <td>Pack lotes X</td>
                  <td>10 Campos - 50 lotes</td>
                  <td>USD 649</td>
                </tr>
                <tr>
                  <td>Lotes</td>
                  <td>Lote adicional</td>
                  <td>Agrega lote adicional en el mismo campo</td>
                  <td>USD 60</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="vigia-glossary">
            <p><strong>Pack lotes:</strong> Corresponde a lotes de un mismo campo</p>
            <p><strong>Lote adicional:</strong> corresponde al agregado de lotes individuales al Pack de lotes</p>
          </div>
        </div>
      </section>
    </div>
